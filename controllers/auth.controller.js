...
export const registerUser = async (req, res) => {
  const { username, email, password } = req.body;
    ...
    // --- TAMBAHKAN LOG DEBUGGING INI DI SINI ---
  console.log('Register User Controller - Full Request Body:', req.body);
  console.log('Register User Controller - Destructured Data:');
  console.log('Username:', username);
  console.log('Email:', email);
  console.log('Password:', password); // Hati-hati logging password di produksi! Hanya untuk debugging lokal.
   // --- AKHIR LOG DEBUGGING ---
  ...
  try {
    ...
    if (avatar) {
      ...
      const uploaded = await cloudinary.uploader.upload(avatar.path, {
        folder: "kel.sendangmulyo/avatar",
